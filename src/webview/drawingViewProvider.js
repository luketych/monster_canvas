...
class DrawingViewProvider {
  ...
  _getHtmlForWebview(webview) {
    ...
    const stylesUri = webview.asWebviewUri(vscode.Uri.file(path.join(this.context.extensionPath, 'src', 'webview', 'styles', 'drawingViewStyles.css')));
    const scriptUri = webview.asWebviewUri(vscode.Uri.file(path.join(this.context.extensionPath, 'src', 'webview', 'js', 'drawingView.js')));
